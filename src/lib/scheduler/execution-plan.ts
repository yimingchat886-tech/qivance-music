...
function buildChatTasks(
  ...
  const definitions: Array<{
    ...
    },
    {
      ...
      outputs: ["data/chains/chat_dialogue_mv/runtime_timeline.json"],
    },
    {
      stage: "build_chat_frames",
      dependencies: ["build_chat_frame_contracts"],
      inputs: ["data/chains/chat_dialogue_mv/runtime_timeline.json"],
      outputs: ["video/html-video/.html-video/projects/<project_id>/runtime/chat_dialogue_mv.html"],
    ...
    },
    {
      ...
      inputs: ["video/html-video/.html-video/projects/<project_id>/runtime/chat_dialogue_mv.html"],
      outputs: [],
    },
    {
      stage: "render_visual",
